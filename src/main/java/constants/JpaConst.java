...
public interface JpaConst {
  //persistence-unit名
    ...
    String REP_COL_START_TIME="start_time";
    String REP_COL_END_TIME="end_time";
    ...
    String FAV_COL_REP = "report_id"; //いいねしたレポートのid
